          ...
          BlocSelector<UserMusicBloc, UserMusicState, List<OwnPlaylist>>(
            ...
            builder: (context, playlists) {
              ...
              return ListView.builder(itemBuilder: (context, index) {
                if (!playlistSelected.containsKey(playlists[index].id!)) {
                  if (playlists[index].songs!.contains(widget.song.encodeId)) {
                    playlistSelected[playlists[index].id!] = true;
                  } else {
                    playlistSelected[playlists[index].id!] = false;
                  }
                }
                ...
                return CheckboxListTile(
                    ...
                    checkColor: ColorTheme.primaryLighten,
