...
class CustomSocialMediaControl extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _CustomSocialMediaControlState();
  }
}

class _CustomSocialMediaControlState extends State<CustomSocialMediaControl>
          ...
          child: Stack(
            children: [
              ...
              Column(
                ...
                children: <Widget>[
                  !notifier.hideStuff
                      ? _buildSongInformation(widget: widget)
                      : Container(),
                  if (_subtitleOn)
                    Transform.translate(
                      offset: Offset(
...
class _buildSongInformation extends StatelessWidget {
  const _buildSongInformation({
    Key? key,
    required this.widget,
  }) : super(key: key);

  final CustomSocialMediaControl widget;
